...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_r     ), spawn "urxvt -e loginctl reboot")
    , ((modm .|. shiftMask, xK_s     ), spawn "urxvt -e loginctl poweroff")
...
------------------------------------------------------------------------
-- Layouts:
myLayout = avoidStruts (noBorders Full ||| tiled ||| Grid ||| Mirror tiled)
  where
     Grid = GridRatio (1/2)
